    ...
    for epoch in range(args.start_epoch,args.epochs):  
        ...
        for phase in ['train', 'val']:  
            ...
            if phase == 'val' and top1.avg > best_acc:  
                ...
                'best_acc': best_acc,
                }, "model_nasnetalarge_finetune_6block_latest.pkl")  
...
def main():
    ...
    for param in model.module.cell_17.parameters():
        param.requires_grad = True
    for param in model.module.cell_16.parameters():
        param.requires_grad = True
    for param in model.module.cell_15.parameters():
        param.requires_grad = True
    for param in model.module.cell_14.parameters():
        param.requires_grad = True
    for param in model.module.cell_13.parameters():
        param.requires_grad = True
    for param in model.module.cell_12.parameters():
        param.requires_grad = True
    ...
    optimizer = torch.optim.Adam(filter(lambda p: p.requires_grad, model.module.parameters()), args.lr,
    ...
    if args.evaluate:
        # print(model.module.cell_17.parameters())
    ...
    torch.save(model.state_dict(), "model_nasnetalarge_6block_finetune.pkl")
